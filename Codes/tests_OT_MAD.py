...
for missing_pourcentage in missing_pourcentage_list:
    for couple in couple_liste:
        ...
        test_runner('OT MAD', data, missing_pourcentage, resultat_path = resultat_path, folder_name = source_number + '_' + target_number + f'_OT_MAD_{missing_pourcentage*100}', seed = random_seed)